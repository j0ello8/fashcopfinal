<x-app-layout>
    ...
    <div class="recommended-projects">
        <h4 class="font-extrabold ml-10 mr-10 text-2xl underline">Similar Projects </h4>
        <h2 class="font-light ml-10 mr-10 text-sm"> Here are some projects which are similar to what you do </h2>
        <div class="grid grid-cols-4 ml-10 mr-10 mb-12">
            @foreach ( $posts as $post)
                <div class="p-3 bg-white border-b border-gray-200 grid grid-rows gap-1">
                        <a href="/p/{{ $post->id }}" >
